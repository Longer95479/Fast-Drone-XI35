...
class FeaturePredictor {
 public:
  ...
  void setCameraParam(const camodocal::CameraPtr& camera_ptr, int img_width,
                      int img_height);
  void resetReferenceFeature(double ts,
  ...
  void update(const std::vector<cv::Point2f>& cur_pts,
