...
class VerticalLineProjectionOneFrameFactor
{
public:
    VerticalLineProjectionOneFrameFactor(const Vector3d &_pt_start, const Vector3d &_pt_end);

    template<typename T>
    bool operator()(const T *const line_st_ptr, const T *const T_wi_ptr, const T *const T_ic_ptr, T *residual_ptr) const;

    static ceres::CostFunction *create(const Vector3d &_pt_start, const Vector3d &_pt_end)
    {
        return (new ceres::AutoDiffCostFunction<VerticalLineProjectionOneFrameFactor, 2, 2, 7, 7>(
            new VerticalLineProjectionOneFrameFactor(_pt_start, _pt_end)));
    }
...
template<typename T>
bool VerticalLineProjectionOneFrameFactor::operator()(const T *const line_st_ptr, const T *const T_wi_ptr, const T *const T_ic_ptr, T *residual_ptr) const
{
...
/****************************************************************************************************************************************************************/
class VerticalLineProjectionTwoFrameFactor
{
public:
    VerticalLineProjectionTwoFrameFactor(const Vector3d &_pt_start, const Vector3d &_pt_end);

    template<typename T>
    bool operator()(const T *const line_st_ptr, const T *const T_wi_ptr, const T *const T_wj_ptr, const T *const T_ic_ptr, T *residual_ptr) const;

    static ceres::CostFunction *create(const Vector3d &_pt_start, const Vector3d &_pt_end)
    {
        return (new ceres::AutoDiffCostFunction<VerticalLineProjectionTwoFrameFactor, 2, 2, 7, 7, 7>(
            new VerticalLineProjectionTwoFrameFactor(_pt_start, _pt_end)));
    }
...
template<typename T>
bool VerticalLineProjectionTwoFrameFactor::operator()(const T *const line_st_ptr, const T *const T_wi_ptr, const T *const T_wj_ptr, const T *const T_ic_ptr, T *residual_ptr) const
{    
    using Vector2T = Eigen::Matrix<T, 2, 1>;
    using Vector3T = Eigen::Matrix<T, 3, 1>;
    using Vector6T = Eigen::Matrix<T, 6, 1>;
