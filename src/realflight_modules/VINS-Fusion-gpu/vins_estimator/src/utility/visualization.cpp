...
ros::Publisher pub_point_cloud, pub_margin_cloud, pub_lines, pub_marg_lines, pub_struct_lines, pub_marg_struct_lines;
...
void registerPub(ros::NodeHandle &n)
{
    ...
    pub_struct_lines = n.advertise<visualization_msgs::Marker>("struct_lines_cloud", 1000);
    pub_marg_struct_lines = n.advertise<visualization_msgs::Marker>("margin_struct_lines_cloud", 1000);
...
visualization_msgs::Marker marg_struct_lines_cloud;  // 全局变量用来保存所有的线段
void pubStructLinesCloud(Estimator &estimator, const std_msgs::Header &header)
{
    ...
    for (auto &it_per_id : estimator.struct_line_manager.struct_line_features)
    {
        ...
        //std::cout<< "used num: " <<used_num<<" line id: "<<it_per_id.feature_id<<std::endl;
        Vector6d line_w = it_per_id.getPlukInWorldFromParam(estimator.local_mht, estimator.Rs, estimator.Ps, estimator.tic, estimator.ric);
        int imu_i = it_per_id.start_frame;
